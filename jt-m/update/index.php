...
<body>
	...
	<!--头部部分，导航-->
	<div class="top-nav">
		<a href="../"><img src="../images/back.png" alt=""><span>版本更新</span></a>
	...
	<div class="data"> 
		<ul>
			<?php
		 		$update  = mysql_query("SELECT * FROM article where state='1' and type='版本更新' order by createTime desc");
		 		while ($update_row=mysql_fetch_array($update)) 
		 		{
		 			echo 
		 			"<li class='hide'>
		 				<a href='detail.php?id=".$update_row['id']."'>
		 					<em>".$update_row['title']."</em><span>".$update_row['createTime']."</span>
		 				</a>
		 			</li>";
		 		}
			?>
