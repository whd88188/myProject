...
<div class="container">
	...
	<div class="allPicture">
		...
		<table class="table table-bordered table-hover">
			...
			<?php
		        ...
		        $result=mysql_query("SELECT * FROM article order by id desc limit $startCount,$pagesize");
				...
				while($row = mysql_fetch_array($result))
				{
				    ...
				    echo "<td><a href='newsHomepageUpdate.php?type=article&id=".$row['id']."'><button type='button' class='homepage'>".$row['homepage']."</button></a></td>";
				    echo "<td><a href='newsStateUpdate.php?type=article&id=".$row['id']."'><button type='button' class='state'>".$row['state']."</button></a></td>";
				    echo "<td><a href='newsPreview.php?type=article&id=".$row['id']."'>预览</a></td>";
				    echo "<td><a href='newsUpdate.php?id=".$row['id']."'>修改</a></td>";
				    echo "<td><a href='newsDeleteDo.php?type=article&id=".$row['id']."'>删除</a></td>";
				    echo "</tr>";
				}
			...
			<tr class="addNews"><td colspan="12"><a href="#add">+添加文章</a></td></tr>
	...
	<div class="allPicture addBox"  >
	    <label id="add">添加文章</label>
		<form action="newsInsert.php?type=article" role="form" method="post">   
		    文章类别：<select class="form-control" name="type" style="display:inline-block; width: 40%;margin: 20px 		 50px 20px 0">
		    				<option value="新闻">新闻</option> 
		    				<option value="公告">公告</option> 
		    				<option value="活动">活动</option>
		    				<option value="攻略">攻略</option>
		    				<option value="攻略">版本更新</option>
		    		  </select>
		    文章标题：<input type="text" class="form-control" name="title" style="display:inline-block; width: 40%;		 margin-bottom: 20px; "  placeholder="请输入文章标题"><br/>
			文章作者：<input type="text" class="form-control" name="author" style="display:inline-block; width: 40%;		 margin: 20px 50px 20px 0;"  placeholder="请输入文章作者">
			...
			文章内容：<script id="editor" type="text/plain" name="content" style="height:500px;"></script>
