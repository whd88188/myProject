...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: https://svn.code.sf.net/p/coppermine/code/trunk/cpg1.5.x/lang/german.php $
  $Revision: 8846 $
**********************************************/
...
$lang_banning_php['email_field_invalid'] = 'Gib eine gültige E-Mail-Adresse ein'; // cpg1.5
...
$lang_contact_php['your_email'] = 'Deine E-Mail-Adresse'; // cpg1.5
...
$lang_contact_php['email_field_mandatory'] = 'Bitte gib Deine E-Mail-Adresse ein'; // cpg1.5 //js-alert
$lang_contact_php['email_field_invalid'] = 'Bitte gib eine gültige E-Mail-Adresse ein'; // cpg1.5 //js-alert
...
$lang_contact_php['failed_sending_email'] = 'Konnte die E-Mail nicht versenden. Bitte versuche es später noch einmal.'; //cpg1.5
$lang_contact_php['email_sent'] = 'Deine E-Mail wurde gesendet.'; //cpg1.5
}
...
$lang_admin_php['email_settings'] = 'E-Mail-Einstellungen  (normalerweise muss hier nichts eingestellt werden; lasse im Zweifelsfall alle Felder leer)'; // cpg1.5
...
$lang_db_ecard_php['invalid_data'] = 'Die Daten für die gewünschte eCard wurden von Deinem E-Mail-Client korrumpiert. Überprüfe den Link auf Vollständigkeit.';
}
...
$lang_ecard_php['your_email'] = 'Deine E-Mail-Adresse';
...
$lang_report_php['your_email'] = 'Deine E-Mail-Adresse';
...
$lang_report_php['invalid_data'] = 'Die Daten des Reports, auf den Du zugreifen willst sind durch Dein E-Mail-Programm zerstört worden. Überprüfe, ob der Link komplett ist.';
}
...
$lang_forgot_passwd_php['enter_email'] = 'Gib Deine E-Mail-Adresse ein';
...
$lang_forgot_passwd_php['email_sent'] = 'Eine E-Mail mit Deinem Benutzernamen und einem neuen Passwort wurde an %s gesendet.';
$lang_forgot_passwd_php['verify_email_sent'] = 'Eine E-Mail wurde an %s gesendet. Bitte überprüfe Deine Mailbox, um den Vorgang abzuschliessen.';
...
$lang_install['email_no_match'] = 'Die E-Mail-Adresse stimmen nicht überein oder sind ungültig.';
$lang_install['email_verif'] = 'Überprüfe E-Mail-Adresse';
...
$lang_register_php['thank_you'] = 'Danke für Deine Registrierung.<br />Eine E-Mail mit Informationen, wie Du Dein Benutzerkonto aktivieren kannst, wurde an die angegebene E-Mail-Adresse gesendet.';
...
$lang_register_php['thank_you_admin_activation'] = 'Danke.<br />Deine Registrierung wurde an den Administrator weitergeleitet zur Aktivierung. Nach erfolgter Aktiverung wirst Du eine E-Mail erhalten.';
...
$lang_send_activation_php['enter_email'] = 'Gib Deine E-Mail-Adresse ein'; //cpg1.5
...
$lang_usermgr_php['note_list'] = 'Wenn Du das derzeitige Passwort nicht ändern willst, lasse das Feld "Passwort" leer';
...
$lang_plugin_php['opensearch_extra'] = 'Möglicherweise solltest Du eine Erklärung auf Deiner Seite veröffentlichen, in der erklärt wird, was dieses Plugin tut'; // cpg1.5
