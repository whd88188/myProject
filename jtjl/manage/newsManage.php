...
<div class="container">
		...
		<table class="table table-bordered table-hover">
			...
			<?php
				...
				while($row = mysql_fetch_array($result))
				{
				    ...
				    echo "<td><a href='newsHomepageUpdate.php?id=".$row['id']."'><button type='button' class='homepage'>".$row['homepage']."</button></a></td>";
				    echo "<td><a href='newsStateUpdate.php?id=".$row['id']."'><button type='button' class='state'>".$row['state']."</button></a></td>";
				    echo "<td><a href='newsPreview.php?id=".$row['id']."'>预览</a></td>";
				    echo "<td><a href='newsUpdate.php?id=".$row['id']."'>修改</a></td>";
				    echo "<td><a href='newsDeleteDo.php?id=".$row['id']."'>删除</a></td>";
				    echo "</tr>";
				}
	...
	<div class="allPicture addBox"  >
		...
		<form action="newsInsert.php" role="form" method="post">   
